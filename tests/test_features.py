...
from src.fortis.imports.features import FeatureDefinition, FeatureType
...
class TestLoadValues:
    ...
    def test_scalar_valid(self):
        ...
        result = FeatureDefinition._load_values("test", raw, FeatureType.scalar)
        assert result.is_ok()
...
class TestFeatureDefinitionLoad:
    def test_binary_minimal(self):
        ...
        assert fd.type == FeatureType.binary
